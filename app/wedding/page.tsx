...
export const metadata: Metadata = {
  ...
  description: 'Your dream wedding starts here. Laza Events provides full-service luxury wedding planning in Qatar, from stage design and floral decor to smooth execution.',
